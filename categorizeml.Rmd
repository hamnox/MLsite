...
# in future I need to get some language approximation going on
cleanedstrings[grepl("bio$", cleanedstrings)] = "Bio modeling (and bio context/pure bio papers)"
cleanedstrings[grepl("3d$", cleanedstrings)] = "3D"
cleanedstrings[grepl("^bayesian|bayesian$", cleanedstrings)] = "Bayesian Neural Nets"
cleanedstrings[grepl("^theory", cleanedstrings)] = "Theory about neural network effectiveness"
cleanedstrings[grepl("video$", cleanedstrings)] = "Video"
cleanedstrings[grepl("^trainingalgorithms$",cleanedstrings)] = "Optimizers / Learning Algorithms"
cleanedstrings[grepl("^generative", cleanedstrings)] = "Generative modeling"
cleanedstrings[grepl("^imagescaptioning$", cleanedstrings)] = "Captioning"
cleanedstrings[grepl("^convolution(pooling)?$", cleanedstrings)] = "Convolution"
cleanedstrings[grepl("^safety|safety$", cleanedstrings)] = "AGI Safety/reliable reinforcement learners"
cleanedstrings[grepl("^applicationscars$", cleanedstrings)] = "Cars"
cleanedstrings[grepl("^applications?|applications?$", cleanedstrings)] = "Misc applications"
cleanedstrings[grepl("architecturesverydeep", cleanedstrings)] = "Very Deep/Vanishing Gradients Problem"
cleanedstrings[grepl("^architecture", cleanedstrings)] = "Architecture"
cleanedstrings[grepl("^imagesfaces?", cleanedstrings)] = "Faces"
cleanedstrings[grepl("embeddings?$", cleanedstrings)] = "Embeddings"
cleanedstrings[grepl("languagemodels", cleanedstrings)] = "\"Language Models\" - next word prediction and etc"
cleanedstrings[grepl("^languagetext", cleanedstrings)] = "Text analysis"
cleanedstrings[grepl("ocr", cleanedstrings)] = "OCR"
cleanedstrings[grepl("images?(semantic)?segmentation", cleanedstrings)] = "Image Object Segmentation/Pixelwise classification"
cleanedstrings[grepl("imagesperpixelprediction", cleanedstrings)] = "Image Object Segmentation/Pixelwise classification"
cleanedstrings[grepl("images?retrieval|images?localization", cleanedstrings)] = "Retrieval"
cleanedstrings[grepl("images?detection", cleanedstrings)] = "Image Object Segmentation/Pixelwise classification"
cleanedstrings[grepl("semisupervised", cleanedstrings)] = "Partially supervised training"
cleanedstrings[grepl("hyperparameters?", cleanedstrings)] = "Hyperparameters techniques"
cleanedstrings[grepl("imagessimilarity", cleanedstrings)] = "Similarity detection"
cleanedstrings[grepl("(language)?talkingcomputers", cleanedstrings)] = "Talking Computers"
cleanedstrings[grepl("representationlearning$", cleanedstrings)] = "Misc Representation Learning"
cleanedstrings[grepl("alternatedeep", cleanedstrings)] = "Alternate/fringe deep techniques"
cleanedstrings[grepl("generality", cleanedstrings)] = "Towards generality"



# add fixed ones
logical = cleanedstrings %in% categories$name
sum(is.na(identified))
identified[logical] = match(cleanedstrings[logical],categories$name)
sum(is.na(identified))
...
sum(logical)
cleanedstrings2 = strtrim(str_trim(str_to_lower(str_replace_all(
  possible_categories[logical,], "[- //.!?,]", ""))), 50)
possible_counts = table(cleanedstrings2)
ordered_counts = possible_counts[order(possible_counts, decreasing=TRUE)]
ordered_counts[1:20]
